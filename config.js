...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'HUMBLE-BOY' : process.env.BOT_NAME, HUMBLE-BOY
  ownername: process.env.OWNER_NAME === undefined ? 'HUMBLE-BOY' : process.env.OWNER_NAME, HUMBLE BOY
  ...
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'King-Md' : process.env.PACK_NAME.split("HUMBLE-TECHNOLOGY;")[1],
